<template>
  <div>
    <Navbar page-title="Fee Management" />
    
    <div class="p-6">
      <div class="bg-white rounded-2xl shadow-lg p-6">
        <h2 class="text-2xl font-bold mb-6">Fee Collection</h2>
          ...
          <table class="w-full">
            ...
            <tbody>
              <tr class="border-b">
                ...
                <td class="px-4 py-3">
                  <button class="text-indigo-600 hover:text-indigo-800">View Receipt</button>
                </td>
              </tr>
            </tbody>
          </table>
